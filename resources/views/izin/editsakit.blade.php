    ...
    <div class="col">
        <form method="POST" action="/izinsakit/{{ $dataizin->kode_izin }}/update" id="formizin" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <input type="text" id="tgl_izin_dari" value="{{ $dataizin->tgl_izin_dari }}" name="tgl_izin_dari" class="form-control datepicker" placeholder="Tanggal Dari" autocomplete="off">
            </div>
            <div class="form-group">
                <input type="text" id="tgl_izin_sampai" value="{{ $dataizin->tgl_izin_sampai }}" name="tgl_izin_sampai" class="form-control datepicker" placeholder="Tanggal Sampai" autocomplete="off">
            </div>
            <div class="form-group">
            ...
            <div class="row">
                <div class="col-12">
                    @php
                        $doc_sid = Storage::url('/uploads/sid/'.$dataizin->doc_sid);
                    @endphp
                    <img src="{{ url($doc_sid) }}" alt="" width="100px" class="img-fluid rounded shadow-sm">
                </div>
            </div>
            @endif
            <div class="custom-file-upload" id="fileUpload1" style="height: 100px !important">
                <input type="file" name="doc_sid" id="fileuploadInput" accept=".png, .jpg, .jpeg">
...
<script>
    ...
    //    });
        ...
        $("#formizin").submit(function(e) {
            ...
            if(tgl_izin_dari == "" || tgl_izin_sampai == "" || keterangan == "") {
                Swal.fire({
                    icon: 'error',
                    title: 'Gagal',
