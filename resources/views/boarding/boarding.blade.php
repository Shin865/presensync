    ...
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu" style="margin-right:10%">
        <ul>
          ...
          <li><a href="index.php#harga">langganan</a></li>
          <li><a href="index.php#tim">Team</a></li>
          <li><a href="index.php#testimon">Testimoni</a></li>
...
<section id="hero" class="hero">
    ...
    <img src="assets/home/assets/img/hero-bg.jpg" alt="" data-aos="fade-in">
...
<img src="assets/gambar/3.jpg" class="img-fluid" alt="">
</div>
      ...
      <div class="col-lg-4">
        <div class="pricing-item">
          ...
          <ul>
            ...
            <li><i class="bi bi-check"></i> <span>Cetak Laporan</span></li>
            <li><i class="bi bi-check"></i> <span>Data Lokasi</span></li>
            <li><i class="bi bi-check"></i> <span>1 Tahun</span></li>
          </ul>
          <div class="text-center"><a href="#" class="buy-btn">Pesan sekarang</a></div>
        </div>
      </div><!-- End Pricing Item -->
    ...
    <div class="row gy-5">
      ...
      <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="200">
        <div class="member-img">
          <img src="assets/gambar/team1.jpg" class="img-fluid" alt="">
        </div>
      ...
      <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="200">
        <div class="member-img">
          <img src="assets/gambar/team2.jpg" class="img-fluid" alt="">
        </div>
        <div class="member-info text-center">
          <h4>Hanny Olivia</h4>
        </div>
      ...
      <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="200">
        <div class="member-img">
          <img src="assets/gambar/team3.jpg" class="img-fluid" alt="">
        </div>
        <div class="member-info text-center">
  ...
  <div class="container">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-5 info" data-aos="fade-up" data-aos-delay="100">
        <h3>Testimoni</h3>
        <p>
          Testimoni di samping mencerminkan pengalaman nyata dari pengguna yang telah menggunakan website
          PresenSync dan puas dengan hasilnya. Testimoni ini menunjukkan kegunaan website tersebut dalam 
          meningkatkan kualitas gambar dengan mudah dan memberikan kesan positif kepada para pengguna.
        </p>
      </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  ...
                  <span>Sebagai seorang fotografer, kualitas gambar sangat penting bagi saya. 
                    Saya telah mencoba berbagai perangkat lunak dan aplikasi untuk meningkatkan kualitas gambar, 
                    tetapi Enhance.Pix benar-benar memukau saya.</span>
